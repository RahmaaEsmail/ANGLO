...
export default function VideoQuestions() {
    ...
    function handleGetAllQuestions() {
        ...
        axios.post('https://camp-coding.org/cairo_u_law_acc/doctor/home/select_questions_videos.php',data_send)
        .then(res => {
            console.log(res)
        ...
        if(imgUrl) {
            ...
            .then(res => {
                if(res?.data) {
                    ...
                    console.log(data_send)
                    axios.post("https://camp-coding.org/cairo_u_law_acc/doctor/home/add_question_videos.php" , data_send)
                    .then(dataRes => {
                        console.log(dataRes)
   ...
   function handleSelectAnswer(id) {
    ...
    function handleDeleteQuestion() {
        ...
        axios.post('https://camp-coding.org/cairo_u_law_acc/doctor/home/delete_question.php',data_send)
        .then(res => {
            if(res?.data == "success") {
    ...
    function handleEditQuestion(e) {
        ...
        if (imgUrl) {    
            ...
            axios.post("https://camp-coding.org/cairo_u_law_acc/doctor/home/image_uplouder.php", formData)
                .then(res => {
                    if (res?.data) {
                        ...
                        return axios.post("https://camp-coding.org/cairo_u_law_acc/doctor/home/edit_video_question.php", data_send);
                    }
                })
                .then(ress =>{
                    if(ress?.data) {
            ...
            axios.post("https://camp-coding.org/cairo_u_law_acc/doctor/home/edit_video_question.php", data_send)
            .then(ress =>{
                if(ress?.data) {
                    setToast({type:"success",message:"The modification was successful."})
                    handleGetAllQuestions();
